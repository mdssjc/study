...
;; PROBLEM
;;
;; Complete the design of all-names that consumes Element and produces
...
;; PROBLEM
;;
;; If the tree is very large, then fold-element is not a good way to
;; implement the find function from last week. Why? If you aren't sure
;; then discover the answer by implementing find using fold-element
;; and then step the two versions with different arguments.
