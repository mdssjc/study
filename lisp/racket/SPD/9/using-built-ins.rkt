...
;; In addition to map and filter there are several other useful
;; abstract list functions built into ISL. These are listed on the
;; Language page of the course web site. Examples of their use are
;; shown below:
...
;; PROBLEM:
;;
;; Complete the design of the following functions by coding them using
;; a built-in abstract list function.
