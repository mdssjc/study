...
;; Improve a function that determines which team knocked a given team
;; out of the tournament.


;; Recall the USA Ultimate championship bracket problem from Two
;; One-Of module.
;;
;; In this problem, you will be asked to improve a function called
;; ouster using local, which is provided at the end of this file.
;;
;; The weekend of October 17-20, 2013, USA Ultimate held its annual
;; national championships tournament in Frisco, Texas.
;;
;; Here is a diagram of the results:
;; file://scores-womens-tournament-13774.png
;;
...
;; PROBLEM:
;;
;; In a tournament, there may be only one champion, but there can be
;; many winners...and losers. Below is a function that takes a bracket
;; and a team and produces the name of the team that knocked the given
;; team out of the tournament, or false if there's no such team in the
;; bracket (either because the team never lost or the given team was
;; not in the bracket).
;;
;; Use the local expression form to improve the function. Briefly,
;; state one justification for using local in this case (there may be
;; more than one).
