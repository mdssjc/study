...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname graphs-v2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; graphs-v2.rkt
...
;; PROBLEM:
;;
;; Design a function that consumes a Room and a room name, and
;; produces true if it is possible to reach a room with the given name
;; starting at the given room. For example:
;;
...
;;
;; But note that if you defined H4F to be the room named F in the H4
;; house then (reachable? H4F "A") would produce false because it is
;; not possible to get to A from F in that house.
