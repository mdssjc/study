...
;; move the cat to the current x position of the mouse
(check-expect (handle-mouse 10 12 0 "button-down") 12)
(check-expect (handle-mouse 15 15 0 "button-down") 15)
(check-expect (handle-mouse 10 15 0 "drag") 10)
(check-expect (handle-mouse 10 12 0 "button-up") 10)
