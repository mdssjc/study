...
\begin{itemize}
	...
	Micro - \textit{Micro Edition}) com a \textit{Device I/O API} (Entrada/Saída - \textit{Input/Output});
	...
	A aplicação utilizará o \textit{Java Oracle Event Processing} (\textit{OEP}).
