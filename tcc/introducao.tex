...
baixo nível, arquitetura Cliente/Servidor - \textit{Client/Server} e Processamento de Eventos
...
O conceito \textit{IoT} é a próxima evolução da computação,
...
Segundo exemplo de aplicação: desenvolver um exemplo de aplicação \textit{Java
  Embedded Suite} (\textit{JES}), explanando o uso da arquitetura Cliente/Servidor em
sistemas embarcados.

Terceiro exemplo de aplicação: desenvolver um exemplo de aplicação \textit{Java
  Oracle Event Processing} (\textit{OEP}), explanando a utilização de Processamento de Eventos Complexos em sistemas embarcados.
