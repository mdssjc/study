...
public class NewFXMain extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    LinearGradient gradient1 = new LinearGradient(0, 1, 0, 0, true,
    ...
    buttonContainer1.getChildren()
                    .addAll(ownerSearchBar, btn1, btn2);
    ...
    buttonContainer2.getChildren()
                    .addAll(numberSearchBar, btn3, btn4);
    ...
    buttonContainer3.getChildren()
                    .addAll(btn5, btn6, btn7, btn8);

    //Other setup and display stuff
    Group root = new Group();
    root.getChildren()
        .addAll(rect1, toolName, marketingJibberish, buttonContainer1,
                buttonContainer2, buttonContainer3);
    ...
    ButtonController buttonController = new ButtonController(accountList,
                                                             ownerSearchBar,
                                                             numberSearchBar,
                                                             btn1, btn2, btn3,
                                                             btn4, btn5, btn6,
