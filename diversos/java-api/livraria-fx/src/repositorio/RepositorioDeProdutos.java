...
public class RepositorioDeProdutos {
  ...
  public ObservableList<Produto> lista() {
    ...
    final Livro livro = new LivroFisico(autor);
    livro.setNome("Java 8 Prático");
    livro.setDescricao("Novos recursos da linguagem");
    livro.setValor(59.90);
    livro.setIsbn("978-85-66250-46-6");

    final Livro maisUmlivro = new LivroFisico(autor);
    ...
    final Autor outroAutor = new Autor();
    outroAutor.setNome("Paulo Silveira");
    outroAutor.setEmail("paulo.silveira@caelum.com.br");
    outroAutor.setCpf("123.456.789.10");

    final Livro outroLivro = new LivroFisico(outroAutor);
