...
public class Index {
  ...
  public static void main(final String[] args) {
    ...
    final var minLength = Integer.parseInt(args[0]);
    final var minOccurrence = Integer.parseInt(args[1]);

    final var words = StdIn.readAllStrings();

    final var st = new ST<String, Queue<Integer>>();
